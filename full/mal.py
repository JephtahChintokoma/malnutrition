...
def if_not_matched(disease):
		...
		# print("")
		result=[print("The most probable disease that you have is %s\n" %(id_disease)),
...
class Greetings(KnowledgeEngine):
	...
	# Declare Facts
			...
			def symptom_7(self):
				self.declare(Fact(smaller_muscles=small_muscles))
	...
	# 		@Rule(Fact(action='find_disease'), NOT(Fact(slight_hair=W())),salience = 20)
	# 		def symptom_20(self):
	# 			self.declare(Fact(slight_hair=slight_hair))	
