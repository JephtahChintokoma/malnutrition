...
def if_not_matched(disease):
		...
		# print("")
		return "The most probable disease that you have is %s\n" %(id_disease),
		"A short description of the disease is given below :\n"
		disease_details+"\n",
		"The common treatments recommended by experts are: \n"
		treatments+"\n"
...
class Greetings(KnowledgeEngine):
	...
	# 		age=request.form.get("age")
			...
			# @Rule(Fact(action='find_disease'), NOT(Fact(bloated_stomach=W())),salience = 20)
			# def symptom_10(self):
			# 	self.declare(Fact(bloated_stomach=bloated_stomach))
			
			# @Rule(Fact(action='find_disease'), NOT(Fact(thin_body=W())),salience = 19)
			# def symptom_11(self):
			...
			# @Rule(Fact(action='find_disease'), NOT(Fact(little_fattie_tissue=W())),salience = 19)
			# def symptom_15(self):
			# 	self.declare(Fact(little_fattie_tissue=little_fattie_tissue))

			# @Rule(Fact(action='find_disease'), NOT(Fact(converse_stomach_rib_prominent=W())),salience = 20)
			# def symptom_16(self):
...
# 		# engine.declare(Fact(smaller_muscles=smaller_muscles))
